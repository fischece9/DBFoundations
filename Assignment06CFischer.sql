...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CFischer')
	 Begin 
	  Alter Database [Assignment06DB_CFischer] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CFischer;
	 End
	Create Database Assignment06DB_CFischer;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CFischer;
...
--	i.count, 8
--	e.EmployeeID, 9
--	e.EmployeeFirstName + ' ' + e.EmployeeLastName As Employee, 10
